...
class _ProfileDetailsState extends State<ProfileDetails> {
          ...
          children: [
            ...
            Container(
              ...
              errorBuilder: (_, _, _) => Icon(
                            ...
                            //           future: ImageService.getDownloadUrlCached(user.selfiePath),
  ...
  Widget _buildInputField({
    ...
    final brandBlue = AppColors.primary;
        ...
        return Container(
          ...
          child: Row(
            children: [
              Icon(
                Icons.place,
                color: editing ? Colors.white : AppColors.primary,
                size: info.scale(24),
              ),
              SizedBox(width: info.scale(12)),
              Expanded(
...
class _DetailRowWithIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: AppColors.primary, size: info.scale(24)),
          SizedBox(width: info.scale(12)),
          Expanded(
            child: Column(
