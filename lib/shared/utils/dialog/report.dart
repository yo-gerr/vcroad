...
import 'package:vcroad_v2/shared/services/marker.dart'; // added import
...
import 'package:vcroad_v2/shared/utils/video/preview.dart';
      ...
      child: RepaintBoundary(
        child: FutureBuilder<Marker>(
          future: MarkerService.instance.getReportMarkerFor(
            ...
            context: context,
            logicalSize: responsive.isDesktop ? 40.0 : 32.0,
          ),
          builder: (ctx, snap) {
