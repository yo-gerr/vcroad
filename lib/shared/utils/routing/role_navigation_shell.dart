...
class RoleNavigationShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _maybeBadge(Widget icon, int index) {
              ...
              destinations: List<NavigationRailDestination>.generate(
                ...
                (i) {
                  ...
                  return NavigationRailDestination(
                    icon: _maybeBadge(dest.icon, i),
                    selectedIcon: _maybeBadge(dest.selectedIcon, i),
                    label: dest.label,
                  );
                },
              ),
              ...
              items: List<BottomNavigationBarItem>.generate(
                ...
                (i) {
                  ...
                  return BottomNavigationBarItem(
                    icon: _maybeBadge(item.icon, i),
                    activeIcon: _maybeBadge(item.activeIcon, i),
                    label: item.label,
                  );
                },
              ),
