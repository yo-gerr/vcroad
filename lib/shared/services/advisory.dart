...
import 'package:vcroad_v2/shared/services/barangay.dart'; // ✅ ADD THIS IMPORT
...
class AdvisoryService {
  ...
  static const String _storageFolder = 'advisory_images';

  // Cloud Function URL for snap-to-road
  static const String _snapToRoadUrl =
      'https://us-central1-vcroad-a0022.cloudfunctions.net/vcroadApi/roads/snap';
  ...
  Future<void> deleteAdvisory(String advisoryId) async {
    try {
      final advisory = await getAdvisoryById(advisoryId);
  ...
  Future<String> uploadImage({
    ...
    try {
      ...
      final fileName =
          '${advisoryId}_${DateTime.now().millisecondsSinceEpoch}.$ext';
      ...
      for (int attempt = 1; attempt <= maxAttempts; attempt++) {
        try {
          ...
          if (response.statusCode != 200) {
            final msg =
                'Snap-to-road failed: ${response.statusCode} - $lastResponseBody';
            throw Exception(msg);
          }

          final data = jsonDecode(lastResponseBody) as Map<String, dynamic>;
