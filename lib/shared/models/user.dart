...
class UserDetails {
  ...
  final String? activeDeviceInfo;
  final DateTime? activeSessionStartedAt;
  final List<Map<String, dynamic>>?
  sessionHistory; // optional: track multiple sessions
  ...
  factory UserDetails.fromJson(Map<String, dynamic> json) {
    return UserDetails(
      ...
      activeDeviceInfo: json['activeDeviceInfo'] as String?,
      activeSessionStartedAt: _toDateTime(json['activeSessionStartedAt']),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'activeSessionStartedAt': _toTimestamp(activeSessionStartedAt),
  ...
  UserDetails copyWith({
    ...
    return UserDetails(
      ...
      activeDeviceInfo: activeDeviceInfo ?? this.activeDeviceInfo,
