...
import 'package:vcroad_v2/shared/services/media_picker.dart';
...
import 'package:vcroad_v2/shared/widgets/report/steps/category.dart';
import 'package:vcroad_v2/shared/widgets/report/steps/media.dart';
import 'package:vcroad_v2/shared/widgets/report/steps/location.dart';
      ...
      children: [
        CircleAvatar(
          ...
          backgroundColor: isCompleted
              ? Colors.green
              : (isActive ? const Color(0xFF001278) : Colors.grey),
          child: isCompleted
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: isActive ? const Color(0xFF001278) : Colors.grey,
